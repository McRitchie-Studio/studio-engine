...
Phase 3 of the studio-engine modal convergence: homes Turf Monster's
quest/leveling activity modals (change username + the quest flows) as engine
primitives, each supporting BOTH modes behind the `:leveling` capability flag.
